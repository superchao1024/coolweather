...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        if (Build.VERSION.SDK_INT>=21){
            ...
            decorView.setSystemUiVisibility(            //改变系统UI的显示
                    View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LAYOUT_STABLE);             //表示活动布局会显示在状态栏上面
        ...
        if (weatherString != null){
            ...
            mWeatherId =weather.basic.weatherId;            //定义一个变量用于记录城市的天气
            //处理并展示Weather实体类中的数据
    ...
    public void requestWeather(final String weatherId){
        String weatherUrl = "http://guolin.tech/api/weather?cityid="+ weatherId + "&key=a8492fce79db44438356f8d47aac5cc0";
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (weather!= null && "ok".equals(weather.status)) {
                            //如果返回的status状态是ok，就说明请求天气成功了，此时将返回的数据缓存到SharedPreferences当中
